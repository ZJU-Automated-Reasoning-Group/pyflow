...
from pyflow.language.python.ast import *
...
from pyflow.language.python.fold import foldBinaryOpAST, foldUnaryPrefixOpAST, foldCallAST
...
class InstructionTranslator(object):
	...
	def initOpHandler(self):
		...
		mungedopmap = {}
		for neumonic, number in opmap.items():
