...
class ConvertCalls(TypeDispatcher):
    ...
    def visitBinaryOp(self, node):
        ...
        return self.directCall(
            node,
            self.exports["interpreter%s" % opname],
            None,
    ...
    def visitUnaryPrefixOp(self, node):
        ...
        return self.directCall(
            node, self.exports["interpreter%s" % opname], None, [self(node.expr)]
        )
    ...
    def visitGetGlobal(self, node):
        ...
        return self.directCall(
            node,
            self.exports["interpreterLoadGlobal"],
            None,
            [self(p.selfparam), self(node.name)],
        )
    ...
    def visitSetGlobal(self, node):
        ...
        call = self.directCall(
            node,
            self.exports["interpreterStoreGlobal"],
            None,
            [self(p.selfparam), self(node.name), self(node.value)],
        )
    ...
    def visitUnpackSequence(self, node):
        ...
        if True:
            dc = self.directCall(
                node,
                self.exports["interpreter_unpack%d" % len(node.targets)],
                None,
                [self(node.expr)],
            )
            ...
            for i, arg in enumerate(node.targets):
                ...
                call = self.directCall(
                    None,
                    self.exports["interpreter_getitem"],
                    None,
    ...
    def visitGetAttr(self, node):
        return self.directCall(
            node,
            self.exports["interpreter_getattribute"],
            None,
            [self(node.expr), self(node.name)],
        )
    ...
    def visitSetAttr(self, node):
        return ast.Discard(
            self.directCall(
                node,
                self.exports["interpreter_setattr"],
                None,
                [self(node.expr), self(node.name), self(node.value)],
            )
        )
    ...
    def visitGetSubscript(self, node):
        return self.directCall(
            ...
            self.exports["interpreter_getitem"],
            None,
            [self(node.expr), self(node.subscript)],
        )
    ...
    def visitSetSubscript(self, node):
        return ast.Discard(
            self.directCall(
                node,
                self.exports["interpreter_setitem"],
                None,
                [self(node.expr), self(node.subscript), self(node.value)],
            )
        )
