...
from pyflow.lib.antlr3.constants import EOF
from pyflow.lib.antlr3.exceptions import NoViableAltException, BacktrackingFailed
	...
	"""
        ...
        try:
            for _ in range(50000):
                ...
                #print("LA = %d (%r)" % (c, chr(c) if c >= 0 else 'EOF'))
