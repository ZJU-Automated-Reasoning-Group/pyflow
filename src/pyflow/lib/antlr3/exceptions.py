...
from pyflow.lib.antlr3.constants import INVALID_TOKEN_TYPE
...
"""
	...
	# generated from a lexer.  We need to track this since the
        ...
        if input is not None:
            ...
            from pyflow.lib.antlr3.streams import TokenStream, CharStream
            from pyflow.lib.antlr3.tree import TreeNodeStream
    ...
    def extractInformationFromTreeNodeStream(self, nodes):
        from pyflow.lib.antlr3.tree import Tree, CommonTree
        from pyflow.lib.antlr3.tokens import CommonToken
    ...
    def getUnexpectedType(self):
        ...
        from pyflow.lib.antlr3.streams import TokenStream
        from pyflow.lib.antlr3.tree import TreeNodeStream
